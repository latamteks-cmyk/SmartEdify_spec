...
### 3.1. Validación de Coherencia con Tenancy
...
#### 4.3.1 Ownership de Catálogos de Roles/Cargos por País
...
- **Fuente de Verdad por País**: 
  - **Perú (PE)**: SUNAT, Ley de Propiedad Horizontal, Reglamento de Condominios
  - **Brasil (BR)**: Lei do Inquilinato, Convenções de Condomínios, Lei das SAs
  - **Chile (CL)**: Ley de Copropiedad, Reglamento de Condominios, Superintendencia de Vivienda
  - **Colombia (CO)**: Ley 675 de 2001, Reglamento de Propiedad Horizontal, Superintendencia de Notariado y Registro
- **Proceso de Actualización**:
  1. Cambios en normativas detectados por `compliance-service`
  2. Nueva versión de catálogo generada con `template_id` y `version`
  3. Publicación de evento `CatalogTemplateUpdated(country, template_id, version)`
  4. Validación por equipo legal de SmartEdify
  5. Aprobación y activación en entornos de prueba
  6. Despliegue gradual a producción por región
...
- **Métricas de seguimiento**:
  - `dsar_job_duration_seconds`: Tiempo total de ejecución del job DSAR
  - `dsar_retry_attempts_total`: Número total de reintentos por job
  - `dsar_compensation_events_total`: Número de eventos de compensación ejecutados
...
-- Constraints Únicos Compuestos y Índices para Perfiles
...
-- Constraints e Índices para Membresías
...
-- Constraints e Índices para Asignaciones de Rol
...
-- Constraints e Índices para Entitlements
...
-- Historial (WORM) - Definiciones de tabla omitidas por brevedad
...
-- Política RLS de ejemplo para una tabla
...
## 📡 12. Catálogo Completo de Eventos Kafka
...
### 12.2 Política de Compatibilidad de Schemas
...
## 🔗 14. Federación B2B y Mapeo de Claims

### 14.1 Proveedores de Identidad Externos Soportados
...
### 14.2 Mapeo de Claims Externos a Atributos Locales
...
### 14.3 Proceso de Provisionamiento Automático
...
## 🛠️ 15. Runbooks de Operaciones

### 15.1 Alta/Traspaso de Plantillas de Roles
...
### 15.2 Recuperación ante Corrupción de Catálogo
