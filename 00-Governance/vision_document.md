...
- **Integración con Streaming**: para registrar participación en sesiones híbridas con timestamps certificados. Se integra con servicios de videoconferencia (como Google Meet) para mejorar la experiencia de usuario en asambleas híbridas a traves de `Streaming-Service`, toda la evidencia crítica se genera y valida internamente:
